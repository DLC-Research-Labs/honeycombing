...
const summary = {
  ...
  caveats: [
    "This is an ensemble-level robustness statement. The enacted 2023/2025 plans are scored only under the presidential "
      + "proxy (the one our VEST precinct data carries); this table does not re-place them under the other proxies.",
