...
SOURCE_URL = "https://www.ncleg.gov/Files/GIS/Plans_Main/Congress_2023/SL%202023-145%20Congress%20-%20Shapefile.zip"
PLAN_ID = "nc-2023-enacted-congressional"
PLAN_NAME = "NC 2023 enacted congressional plan"
SOURCE = "North Carolina General Assembly"
CYCLE = "2024"
STATUS = "enacted"
OUTPUT_PATH = Path("public/data/plans/nc-2023-enacted-congressional.json")


def main() -> None:
    with tempfile.TemporaryDirectory() as tmp_dir:
        zip_path = Path(tmp_dir) / "nc-2023-congressional.zip"
        ...
        features.append(
            {
                ...
                "properties": {
                    ...
                    "source_plan_name": "SL 2023-145 Congressional",
