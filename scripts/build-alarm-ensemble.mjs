...
Generated by \`scripts/build-alarm-ensemble.mjs\` on 2026-07-03.
...
The 2023 enacted plan sits at the ${comparedPlans[2].percentile} percentile of the ensemble seat distribution
(${comparedPlans[2].value} Democratic seats against an ensemble median of 6) — a low outlier under
\`classifyEnsemblePercentile\`. The 2022 court plan sits at the ${comparedPlans[1].percentile} percentile — high edge,
not an outlier. Whether the enacted plan's position reflects unlawful intent is NOT concluded here; the ensemble's
constraint set is the entire meaning of these percentiles.
